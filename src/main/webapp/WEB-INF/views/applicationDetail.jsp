		...
		<table class="info-table table-4col">
			<tbody>
				...
				<tr>
					...
					<td><c:choose>
							<c:when test="${not empty app.businessRegiNumber}">
				...
				<tr>
					...
					<td colspan="3"><c:choose>
							<c:when
								test="${empty app.businessZipNumber and empty app.businessAddrBase and empty app.businessAddrDetail}">
								미입력
							</c:when>
							<c:otherwise>
